				...
				<ul>
					...
					<li>
						...
						<div class="input datetime_input">
                                                <label for="day_id"><?php echo lang('pages:day_label') ?></label>
                                                    <?php echo form_dropdown(
                                                            'day', 
                                                            array(
                                                                '1'=>lang('pages:monday_label'), 
                                                                '2'=>lang('pages:tuesday_label'), 
                                                                '3'=>lang('pages:wednesday_label'), 
                                                                '4'=>lang('pages:thursday_label'), 
                                                                '5'=>lang('pages:friday_label'), 
                                                                '6'=>lang('pages:saturday_label'), 
                                                                '7'=>lang('pages:sunday_label'), 
                                                                ), 
                                                            $page->day, 
                                                            'id="day_id"')
                                                     ?>
                                                ...
                                                ?>
						<label for="hour_from_id"><?php echo lang('pages:hour_from_label') ?></label>
                                                    <?php echo form_dropdown(
                                                            'hour_from', 
                                                            $hours,
                                                            $page->hour_from, 
                                                    ...
                                                    <?php echo form_dropdown(
                                                            ...
                                                            'id="minute_from_id"')
                                                     ?>
						<label for="hour_to_id"><?php echo lang('pages:hour_to_label') ?></label>
                                                    <?php echo form_dropdown(
                                                            'hour_to', 
                                                            $hours,
                                                            $page->hour_to, 
