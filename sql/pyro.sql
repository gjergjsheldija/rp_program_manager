...
--
-- Host: localhost
-- Generation Time: Oct 25, 2013 at 09:10 AM
...
(1, 'Default Site', 'default', 'localhost', 1, 1375112525, 0);
...
(1, 'gjergj.sheldija@gmail.com', '58d07785f518356cebc4b4b6afa5b38b82668246', '2738d', 1, '', 1, '', 1375112525, 1375112525, 'admin', NULL, NULL);
...
('50df42b0b0adeb106da0762ec8083bbb', '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.71 Safari/537.36', 1375112547, ''),
('0c1e4245bf8458268a616e4f484de6be', '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.71 Safari/537.36', 1375172893, 'a:6:{s:8:"username";s:5:"admin";s:5:"email";s:25:"gjergj.sheldija@gmail.com";s:2:"id";s:1:"1";s:7:"user_id";s:1:"1";s:8:"group_id";s:1:"1";s:5:"group";s:5:"admin";}');
...
(1, '2013-07-29 15:42:15', '2013-07-30 12:25:33', 1, NULL, '<p>Welcome to our homepage. We have not quite finished setting up our website yet, but please add us to your bookmarks and come back soon.</p>\n'),
(2, '2013-07-29 15:42:15', NULL, 1, NULL, '<p>To contact us please fill out the form below.</p>\n				{{ contact:form name="text|required" email="text|required|valid_email" subject="dropdown|Support|Sales|Feedback|Other" message="textarea" attachment="file|zip" }}\n					<div><label for="name">Name:</label>{{ name }}</div>\n					<div><label for="email">Email:</label>{{ email }}</div>\n					<div><label for="subject">Subject:</label>{{ subject }}</div>\n					<div><label for="message">Message:</label>{{ message }}</div>\n					<div><label for="attachment">Attach  a zip file:</label>{{ attachment }}</div>\n				{{ /contact:form }}'),
(3, '2013-07-29 15:42:15', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}'),
(4, '2013-07-29 15:42:15', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}\n\n{{ search:results }}\n\n	{{ total }} results for "{{ query }}".\n\n	<hr />\n\n	{{ entries }}\n\n		<article>\n			<h4>{{ singular }}: <a href="{{ url }}">{{ title }}</a></h4>\n			<p>{{ description }}</p>\n		</article>\n\n	{{ /entries }}\n\n        {{ pagination }}\n\n{{ /search:results }}'),
(5, '2013-07-29 15:42:15', NULL, 1, NULL, '<p>We cannot find the page you are looking for, please click <a title="Home" href="{{ pages:url id=''1'' }}">here</a> to go to the homepage.</p>');
...
CREATE TABLE IF NOT EXISTS `default_pages` (
  ...
  `minute_from` int(11) NOT NULL,
  `hour_to` int(11) NOT NULL,
  `minute_to` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `slug` (`slug`),
...
INSERT INTO `default_pages` (`id`, `slug`, `class`, `title`, `uri`, `parent_id`, `type_id`, `entry_id`, `css`, `js`, `meta_title`, `meta_keywords`, `meta_robots_no_index`, `meta_robots_no_follow`, `meta_description`, `rss_enabled`, `comments_enabled`, `status`, `created_on`, `updated_on`, `restricted_to`, `is_home`, `strict_uri`, `order`, `day`, `hour_from`, `minute_from`, `hour_to`, `minute_to`) VALUES
(1, 'home', '', 'Home', 'home', 0, '1', '1', '', '', '', '', 0, 0, '', 0, 0, 'live', 1375112537, 1375172733, '0', 1, 1, 1375112537, 2, 13, 0, 14, 0),
(2, 'contact', '', 'Contact', 'contact', 0, '1', '2', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1375112537, 0, '', 0, 1, 1375112537, 0, 0, 0, 0, 0),
(3, 'search', '', 'Search', 'search', 0, '1', '3', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1375112537, 0, '', 0, 1, 1375112537, 0, 0, 0, 0, 0),
(4, 'results', '', 'Results', 'search/results', 3, '1', '4', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1375112537, 0, '', 0, 0, 1375112537, 0, 0, 0, 0, 0),
(5, '404', '', 'Page missing', '404', 0, '1', '5', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1375112537, 0, '', 0, 1, 1375112537, 0, 0, 0, 0, 0);
...
(1, NULL, NULL, NULL, NULL, 1, 'gjergj sheldija', 'gjergj', 'sheldija', '', 'en', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(53, 'Home', '', NULL, NULL, 'pages', 'pages:page', 'pages:pages', '1', 'home', 'admin/pages/edit/1', 'admin/pages/delete/1'),
...
('contact_email', 'Contact E-mail', 'All e-mails from users, guests and the site will go to this e-mail address.', 'text', 'gjergj.sheldija@gmail.com', '', '', 1, 1, 'email', 979),
...
('nb_iframe_location', 'Nice Debug Iframe Location', 'Iframe location to embed for the nice debug panel', 'text', 'http://localhost:8080/index.phpadmin', 'http://localhost:8080/index.phpadmin', '', 0, 1, 'nice_debug', 104),
('nb_iframe_title', 'Nice Debug Iframe Title', 'Title to display for the iframe tab in the nice debug panel. (Leaving this blank will remove the iframe tab)', 'text', 'Admin Panel', 'Admin Panel', '', 0, 1, 'nice_debug', 103),
('nb_jquery', 'Enable Jquery', 'Disable this if your frontend theme already includes the jquery library', 'select', 'yes', 'yes', 'no=Disabled|yes=Enabled', 1, 1, 'nice_debug', 101),
('nb_jquery_ui', 'Enable Jquery UI', 'Disable this if your frontend theme already includes the jquery ui library', 'select', 'yes', 'yes', 'no=Disabled|yes=Enabled', 1, 1, 'nice_debug', 102),
('nb_theme', 'Nice Debug Theme', 'Style Nice Debug with a range of pre-made themes', 'select', 'laravel', 'github', 'laravel=Laravel|github=Github|tnb=Tomorow Night Bright|hemisulight=Hemisu Light|hemisudark=Hemisu Dark|dark-blue=Dark Blue|dark-red=Dark Red|dark-green=Dark Green|dark-yellow=Dark Yellow|dark-pink=Dark Pink|dark-orange=Dark Orange|dark-purple=Dark Purple', 1, 1, 'nice_debug', 105),
...
('site_name', 'Site Name', 'The name of the website for page titles and for use around the site.', 'text', 'Un-named Website', 'radio pulla streaming', '', 1, 1, '', 1000),
...
(1, 'show_breadcrumbs', 'Show Breadcrumbs', 'Would you like to display breadcrumbs?', 'radio', 'yes', 'no', 'yes=Yes|no=No', 1, 'default'),
...
(7, 'background', 'Background', 'Choose the default background for the theme.', 'select', 'fabric', 'black', 'black=Black|fabric=Fabric|graph=Graph|leather=Leather|noise=Noise|texture=Texture', 1, 'base'),
(8, 'slider', 'Slider', 'Would you like to display the slider on the homepage?', 'radio', 'yes', 'no', 'yes=Yes|no=No', 1, 'base'),
(9, 'color', 'Default Theme Color', 'This changes things like background color, link colors etc…', 'select', 'pink', 'red', 'red=Red|orange=Orange|yellow=Yellow|green=Green|blue=Blue|pink=Pink', 1, 'base'),
...
(1, 'gjergj.sheldija@gmail.com', '58d07785f518356cebc4b4b6afa5b38b82668246', '2738d', 1, '', 1, '', 1375112525, 1375112552, 'admin', NULL, '1904e9a2c0eeb8b7df3130b6a2bd9759fe255c1e');
